...
{
	string s; bool phase;
	cerr << "Please indicate if the phase is known" << endl
...
{
	cerr << "Please indicate which file format you'll be using for individuals" << endl
...
{
	string s;
	cerr << "Please indicate output file location: " << endl;
	cin >> s;
	return s;
}
